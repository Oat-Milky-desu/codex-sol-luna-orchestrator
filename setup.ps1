...
function Read-Plan {
    ...
    [Console]::WriteLine('  1) Pro  - GPT-6 Sol (medium) orchestrates, GPT-6 Luna (max) executes, GPT-6 Sol (medium) reviews')
    [Console]::WriteLine('  2) Plus - GPT-6 Sol (medium) orchestrates, GPT-6 Luna (max) executes, GPT-6 Sol (medium) reviews')
    [Console]::WriteLine('  3) Pro (max 2 subagents) - GPT-6 Sol (medium) orchestrates, GPT-6 Luna (max) executes, GPT-6 Sol (medium) reviews')
    [Console]::WriteLine('  4) Plus (max 2 subagents) - GPT-6 Sol (medium) orchestrates, GPT-6 Luna (max) executes, GPT-6 Sol (medium) reviews')
